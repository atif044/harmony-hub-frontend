    ...
    <div className=''>
        <form onSubmit={onSubmit}>
            ...
            <div className="mt-4">
                ...
                <input className={`w-full  md:w-6/12 shadow-inner ${darkMode==="dark"?"bg-zinc-600 text-white":"bg-gray-100"}  rounded-lg placeholder-black text-2xl pl-2  border-none block mt-1`} onChange={onChange} value={credentials.password} id="password" type="password" name="password"  required autoComplete="off"/>
            </div>
