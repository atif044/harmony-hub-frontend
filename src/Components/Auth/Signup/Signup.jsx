...
const Signup = ({darkMode}) => {
  ...
  return (
    ...
    <h1 className={`mb-8 font-bold text-4xl ${darkMode==="dark"?"text-white":"text-black"}`}>Register - User</h1>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <form >
            ...
            <div className="mt-4">
                ...
                <input className={`w-full shadow-inner ${darkMode==="dark"?"bg-zinc-600  text-white":"bg-gray-100"}  rounded-lg placeholder-black text-2xl pl-2  border-none block mt-1`} id="password" type="password" name="password" value={credentials.password} onChange={onChange} required autoComplete="off"/>
            </div>
            ...
            <div className="flex items-center justify-between mt-8">
                ...
                <Link className={`${darkMode==="dark"?"text-white":"text-black"} font-semibold`} to="/loginuser">
                    Already registered?
                </Link>
            </div>
        </form>
