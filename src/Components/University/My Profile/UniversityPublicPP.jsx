...
import SignupUniversity from './../Auth/Signup/SignupUniversity';
const UniversityPublicProfilePage = () => {
    const {id}=useParams();
        const {getMyUniPublicProfile}=useContext(context)
        const [myData,setMyData]=useState({});

    const fetchMyProfile=async()=>{
        try {
            let response=await getMyUniPublicProfile(id);
...
export default UniversityPublicProfilePage;
